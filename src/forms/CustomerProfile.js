...
const CustomerProfile = () => {
  ...
  useEffect(() => {
    ...
    const deletePaymentInfo = async (e) => {
      e.preventDefault();
      try {
        await axios.post(process.env.REACT_APP_BASE_URL + '/customer/delete-payment-details', { userID });
        fetchPaymentInfo();
        setPaymentEditing(false);
      } catch (error) {
      ...
      <div className="rightContainer">
        ...
        <div className="paymentContainer">
          ...
          {paymentProfile.length === 0 && (
            <div className="blankCreditCardContainer">
              <div className="blankCreditCard">
                <div className="blankCreditCardMargin">
                  <div className="blankCreditCardTop">
                    <div className="blankLogo">
                      ADD A CARD
                    </div>
                  </div>
                    <div className="blankCreditCardMiddle">
                      <p className="blankCreditCardNumber"> 0123 4567 8910 1112 </p>
                    </div>
                    <div className="blankCreditCardBottomHeader">
                      <p className="blankCreditCardBottomTitles"> CARD HOLDER </p>
                      <p className="blankCreditCardBottomTitles"> EXPIRATION </p>
                    </div>
                    <div className="blankCreditCardBottom">
                      <p className="blankCreditCardBottomData"> John Doe </p>
                      <p className="blankCreditCardBottomData"> 11/24 </p>
                    </div>
                  </div>
              </div>
            </div>
              ...
              {paymentEditing ? (
                  ...
                  <div className="paymentEditArea">
                    <div className="creditCardInfo">
                      ...
                      <input
                        ...
                        value={paymentFormData.UnformattedCardNumber}
                    ...
                    <div className="blankPaymentSaveArea">
                ...
                <>
                  <div className="creditCardInfo">
                    ...
                    <p className="userData"> No Card Added </p>
                  </div>
                  <div className="creditCardInfo">
                    <p className="label"> Card Number </p>
                    <p className="userData"> 0123 4567 8910 1112 </p>
                  </div>
                  <div className="creditCardInfo">
                    <p className="label"> Card Holder </p>
                    <p className="userData"> John Doe </p>
                  </div>
                  <div className="creditCardInfo">
                    <p className="label"> Expiration </p>
                    <p className="userData"> 11/24 </p>
                  </div>
                  <div className="creditCardInfo">
                    <p className="label"> CVV </p>
                    <p className="userData"> 123 </p>
                  </div>
                </>
              )}
            </div>
              ...
              <form className="paymentEditContainer" onSubmit={handlePaymentSubmit}>
                <div className="paymentEditArea">
                  ...
                  <div className="paymentSaveArea">
                    <button onClick={deletePaymentInfo} className="deleteButton"> Delete </button>
                    <button type="submit" className="paymentSaveButton"> Save </button>
                  </div>
                </div>       
              </form>
